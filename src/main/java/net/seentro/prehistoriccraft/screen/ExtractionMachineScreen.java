...
import net.seentro.prehistoriccraft.screen.renderer.EnergyDisplayTooltipArea;
import net.seentro.prehistoriccraft.util.inventorypower.MouseUtil;
...
public class ExtractionMachineScreen extends AbstractContainerScreen<ExtractionMachineMenu> {
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if (menu.isCrafting()) {
            guiGraphics.blit(GUI_TEXTURE, x + 64 /*64*/, y + 64 /*36*/, 176 /*176*/, 33 /*33*/, 49 /*49*/, (int) menu.getScaledProgress());
            if (isCrafting == 0) {
    ...
    private void renderEnergyBar(GuiGraphics guiGraphics, int x, int y) {
        guiGraphics.blit(GUI_TEXTURE, x + 44 /*48*/, y + 74 - menu.getEnergyBarAmount() /*74*/, 176 /*180*/, 37 - menu.getEnergyBarAmount() /*81*/, 4 /*-4*/, menu.getEnergyBarAmount());
    }
