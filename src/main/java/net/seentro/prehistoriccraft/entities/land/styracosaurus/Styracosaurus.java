...
public class Styracosaurus extends LandDinosaur implements SmartBrainOwner<Styracosaurus>, GeoEntity {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        ...
        controllers.add(new AnimationController<>(this, "molang", 0, this::molangPredicate));
    }
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> animationState) {
        ...
        return switch (idleToPlay) {
            ...
            case 3 -> animationState.setAndContinue(RawAnimation.begin().then("idle3", Animation.LoopType.PLAY_ONCE).thenLoop("idle"));
            default -> PlayState.CONTINUE;
        };
    }

    private <T extends GeoAnimatable> PlayState molangPredicate(AnimationState<T> animationState) {
        return animationState.setAndContinue(RawAnimation.begin().thenLoop("animation.model.molang"));
    }
