...
public class PachypterisSatchet extends Item {
    public PachypterisSatchet(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        level.setBlockAndUpdate(pos.above(), ModBlocks.PACHYPTERIS_SAPLING.get().defaultBlockState());
