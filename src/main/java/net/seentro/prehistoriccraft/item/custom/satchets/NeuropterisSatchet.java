...
public class NeuropterisSatchet extends Item {
    public NeuropterisSatchet(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        level.setBlockAndUpdate(pos.above(), ModBlocks.NEUROPTERIS_SAPLING.get().defaultBlockState());
