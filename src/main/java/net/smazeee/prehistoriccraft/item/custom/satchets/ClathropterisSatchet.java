...
public class ClathropterisSatchet extends Item {
    public ClathropterisSatchet(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        level.setBlockAndUpdate(pos.above(), ModBlocks.CLATHROPTERIS.get().defaultBlockState());
